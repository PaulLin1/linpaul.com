...
This project began as part of my submission for [SemEval-2025 Task 11: Bridging the Gap in Text-Based Emotion Detection](https://arxiv.org/abs/2503.07269). The final pipeline included an ensemble with a Graph Neural Network inspired by [EmoGraph](https://arxiv.org/abs/2008.09378). Unfortunately, I did not have time to create a proper submission, nor did I have any paper writing experience at the time. The original competition repository can be found [here](https://github.com/PaulLin1/semeval-2025).
